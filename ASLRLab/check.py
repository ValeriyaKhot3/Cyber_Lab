...
def main():
    ...
    if args.part == '2a' or args.part == 'all':
        ...
        points_possible += 10
        if check("part2/a", 1000, b"Technion{nic3_s0lv3!}", 0.50):
            points += 10
    if args.part == '2b' or args.part == 'all':
        ...
        points_possible += 20
        if check("part2/b", 1000, b"Technion{lab_p4rtTw0_1s_d0n3}", 0.50):
            points += 20
    if args.part == '3' or args.part == 'all':
        print("Checking part 3...")
        points_possible += 10
        os.chdir('part3')
        if check("part3", 1000, b"Technion{and_thats_all_folks!}", 0.50):
            points += 10
